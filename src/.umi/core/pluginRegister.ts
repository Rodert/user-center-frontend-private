...
import * as Plugin_2 from 'D:/myworkspace/MyJavaPub/user-center-frontend-private/src/.umi/plugin-access/rootContainer.ts';
...
import * as Plugin_5 from '../plugin-model/runtime';
  ...
  plugin.register({
    apply: Plugin_2,
    path: 'D:/myworkspace/MyJavaPub/user-center-frontend-private/src/.umi/plugin-access/rootContainer.ts',
  });
  plugin.register({
    apply: Plugin_3,

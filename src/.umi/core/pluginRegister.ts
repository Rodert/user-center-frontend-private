...
import * as Plugin_2 from '/Users/shiyuwang/home/me/apps/user-center-frontend-private/src/.umi/plugin-access/rootContainer.ts';
...
import * as Plugin_5 from '../plugin-model/runtime';
  ...
  plugin.register({
    apply: Plugin_2,
    path: '/Users/shiyuwang/home/me/apps/user-center-frontend-private/src/.umi/plugin-access/rootContainer.ts',
  });
  plugin.register({
    apply: Plugin_3,
